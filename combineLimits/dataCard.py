...
if __name__ == '__main__':
	...
	os.system('cp '+fileDir+'templates_'+template+'/templates_'+iPlot+'_'+lumiStr+tag+'_rebinned_stat0p3_bdtcorr_Norm.root ./limits_'+template+saveKey+'/')
	rfile = './limits_'+template+saveKey+'/templates_'+iPlot+'_'+lumiStr+tag+'_rebinned_stat0p3_bdtcorr_Norm.root'
