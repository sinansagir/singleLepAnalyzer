...
templateDir = os.getcwd()+'/templates_minMlb_tptp_2016_3_18/'
...
rfiles = [file for file in findfiles(templateDir+cutString, '*.root') if '00_2p318fb' not in file and 'rebinned' not in file]
