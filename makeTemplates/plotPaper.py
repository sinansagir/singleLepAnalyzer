...
def formatUpperHist(histogram,th1hist):
	...
	if 'PrunedNsubBNm1' in histogram.GetName(): 
		histogram.GetXaxis().SetTitle("b-tagged subjet multiplicity")
		histogram.GetXaxis().SetNdivisions(3,kFALSE)
