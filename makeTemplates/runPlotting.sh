...
plotList='NBDeepJetsNoSF NBDeepJets NBJetsNoSF NBJets'
for iPlot in $plotList; do
    echo $iPlot
    python plotTemplates.py $iPlot PS False kinematicsPS_April2020_BB False False 
    python plotTemplates.py $iPlot PS False kinematicsPS_April2020_BB False True  
