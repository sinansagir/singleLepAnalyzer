...
cutString=''#s'lep50_MET30_DR0_1jet50_2jet40'
pfix='templates'
...
templateDir=os.getcwd()+'/'+pfix+'_2017_2_2/'+cutString+'/' #for signal efficiency
...
elif 'HTB' in sig1: bkgHistColors = {'ttbar':kGreen-3,'wjets':kPink-4,'ttbb':kGreen-5,'ttcc':kGreen,'ttlf':kGreen+3,'wjetsb':kRed-9,'wjetsc':kPink-4,'wjetsl':kBlue-7,'top':kAzure+8,'ewk':kMagenta-2,'qcd':kOrange+5} #HTB
