...
cutString = 'split'#'lep30_MET150_NJets4_DR1_1jet450_2jet150'
...
bkgProcList = ['TTbar','WJets','DYJets','SingleTop','ewk','QCD'] #put the most dominant process first
era = "13TeV"
...
for chn in totBkgHists.keys():
	if ('H1b' not in chn and 'H2b' not in chn) or iPlot != 'minMlbST':
