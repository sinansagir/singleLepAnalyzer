...
step1Dir = '/user_data/jhogan/LJMet80X_1lepTT_113016_step2slimmed/nominal'

iPlot = 'minMlj' #minMlb' #choose a discriminant from plotList below!
...
if region=='TTCR': pfix='ttbarTEST_'
elif region=='WJCR': pfix='wjetsTEST_'
...
cutList = {'lepPtCut':40,'metCut':75,'njetsCut':3,'drCut':1,'jet1PtCut':300,'jet2PtCut':150,'jet3PtCut':100}
if region=='PS':cutList = {'lepPtCut':40,'metCut':60,'njetsCut':3,'drCut':0,'jet1PtCut':200,'jet2PtCut':100, 'jet3PtCut':50}
...
plotList = {#discriminantName:(discriminantLJMETName, binning, xAxisLabel)
	...
	'NH1bJets':('NJetsH1btagged',linspace(0, 4, 5).tolist(),';H1b tag multiplicity;'),
	'NH2bJets':('NJetsH2btagged',linspace(0, 4, 5).tolist(),';H2b tag multiplicity;'),
	...
	'PrunedSmeared' :('theJetAK8PrunedMassWtagUncerts_JetSubCalc_PtOrdered',linspace(0, 500, 51).tolist(),';AK8 Jet Pruned mass [GeV];'),
