...
tempKey='postfit'
limitDir='templates_M17WtSF_2017_3_31_SRpCRplotsTEST/'+tempKey+'/'
LH700file='/mle_covcorr_templates_'+discriminant+'_X53X53M900'+spin+'_'+str(lumiStr)+'fb'+isRebinned+'.root'
