...
if not os.path.exists('/uscms_data/d3/escharni/CMSSW_10_2_10/src/singleLepAnalyzer/thetaLimits/limitsJul19/'+templateDir.split('/')[-1]): os.system('mkdir /uscms_data/d3/escharni/CMSSW_10_2_10/src/singleLepAnalyzer/thetaLimits/limitsJul19/'+templateDir.split('/')[-1])
outputDir = '/uscms_data/d3/escharni/CMSSW_10_2_10/src/singleLepAnalyzer/thetaLimits/limitsJul19/'+templateDir.split('/')[-1]+'/'
limitType = 'comb1718'
...
for file in rootfilelist:
    ...
    dict={'rundir':runDir,'configdir':outDir+fileDir,'configfile':file.split('/')[-1][:-5],'file1L17':file,'file1L18':file1L2018}
