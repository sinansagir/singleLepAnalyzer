...
def PlotLimits(limitDir,limitFile,chiral):
    ...
    canvas.SaveAs('LimitPlot_'+chiral+'_combo.eps')
    canvas.SaveAs('LimitPlot_'+chiral+'_combo.pdf')
    canvas.SaveAs('LimitPlot_'+chiral+'_combo.png')
    canvas.SaveAs('LimitPlot_'+chiral+'_combo.root')
