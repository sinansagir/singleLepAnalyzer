...
def getLJetsModel():
    ...
    for obs in obsvs:
		...
		if 'nT1p_nW1p_nB2p' in obs:
			...
			if 'ewk' in obs: model.add_lognormal_uncertainty('ewk1pT1pW2pBSys',math.log(1.13),'ewk', obs) # from Wjets CR
...
def getSSDLModel():
    model = build_model_from_rootfile('/home/ssagir/CMSSW_7_3_0/src/singleLepAnalyzer/x53x53_2015/combination/templates_ssdl_15Sep16/Limits_M1400_RH_Ch_All_LL40_SL30_HT900_nConst5_thetamuMiniIso.root',include_mc_uncertainties=True)
...
plot_exp.write_txt('X53X53_Combination_M1400_RH_expected.txt')
plot_obs.write_txt('X53X53_Combination_M1400_RH_observed.txt')

#signal_process_groups = {'sig': ['sig']}
#import json
#f = open('X53X53_Combination_M1400_RH_discovery.json', 'w')
#disc = discovery(ssdlModel,use_data = False,input_expected='toys:0.00342',spid='sig',Z_error_max=0.1,ts_method=derll)
#print disc
#json.dump(disc, f)
...
report.write_html('X53X53_Combination_M1400_RH_html')
