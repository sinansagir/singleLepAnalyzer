...
def getSSDLModel():
    model = build_model_from_rootfile('/home/ssagir/CMSSW_7_3_0/src/singleLepAnalyzer/x53x53_2015/combination/templates_ssdl_15Sep16/Limits_M800_RH_Ch_All_LL40_SL30_HT900_nConst5_thetamuMiniIso.root',include_mc_uncertainties=True)
...
plot_exp.write_txt('X53X53_Combination_M800_RH_expected.txt')
plot_obs.write_txt('X53X53_Combination_M800_RH_observed.txt')

#signal_process_groups = {'sig': ['sig']}
#import json
#f = open('X53X53_Combination_M800_RH_discovery.json', 'w')
...
report.write_html('X53X53_Combination_M800_RH_html')
